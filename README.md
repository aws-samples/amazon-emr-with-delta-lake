...
2. Create an EMR Cluster using AWS CDK. (Check details in [instructions](./cdk/emr-cluster/INSTRUCTIONS.md))
3. Create an EMR Studio using AWS CDK. (Check details in [instructions](./cdk/emr-studio/INSTRUCTIONS.md))
